...
​bats.score: Defines the final tally of Wins earned by a Player in a session.
​🎮 How to Play
​Join a Lobby: A Player starts a session and becomes the first Card Czar.
​Submit a Play: Players submit play records matching their funniest White cards to the active Black card.
​Pick a Winner: The Card Czar selects the winning response for that round.
​Final Score: At the end of the session, a score record is signed, immortalizing the top Player of the round.
